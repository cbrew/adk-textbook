"""
State management tools for Research State Agent.
...
def add_research_source_tool(title: str, url: str, source_type: str,
    tool_context: ToolContext
) -> dict[str, Any]:
    """
...
def set_research_topic_tool(topic: str,
    tool_context: ToolContext
) -> dict[str, Any]:
    """
...
def add_research_progress_tool(step: str, tool_context: ToolContext
) -> dict[str, Any]:
    """
...
def get_research_status_tool(key: str, tool_context: ToolContext
) -> dict[str, Any]:
    """
    Get current research status from session state.
    In adk version 1.13 it does not work to have a tool that has only the tool
    context as an argument. Hence key is provided.
